...
import { queryAllNfts } from "@/helpers/cw721";
...
export function Dropdown() {
	...
	const cw721Address = process.env.NEXT_PUBLIC_CW721_CONTRACT_ADDRESS;

	useEffect(() => {
		async function fetchOwnedAssets() {
			const ownedAssets = await queryAllNfts(client, cw721Address as string);
